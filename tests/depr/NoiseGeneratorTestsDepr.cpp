#include "../../kalman_filter_1d/depr/GaussianNoiseGeneratorDepr.h"
#include "catch2/catch.hpp"
#include "snowhouse/snowhouse.h"

using namespace snowhouse;

TEST_CASE("Gaussian noise generator should have a mean at zero and should follow gaussian distribution_", "[random-test]") {
    ...
    GaussianNoiseGeneratorDepr noiseGenerator;
